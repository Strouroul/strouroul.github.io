 ...
 **/(function (a) {
    ...
    let c = !1, d = function () {
        ...
        factor: function (a, b, c) {
            let d = a.data('paroller-factor'), e = d ? d : c.factor;
            if (576 > b) {
                let b = a.data('paroller-factor-xs'), d = b ? b : c.factorXs;
                return d ? d : e
            }
            if (768 >= b) {
                let b = a.data('paroller-factor-sm'), d = b ? b : c.factorSm;
                return d ? d : e
            }
            if (1024 >= b) {
                let b = a.data('paroller-factor-md'), d = b ? b : c.factorMd;
                return d ? d : e
            }
            if (1200 >= b) {
                let b = a.data('paroller-factor-lg'), d = b ? b : c.factorLg;
                return d ? d : e
            }
            if (1920 >= b) {
                let b = a.data('paroller-factor-xl'), d = b ? b : c.factorXl;
                return d ? d : e
            }
            return e
    ...
    a.fn.paroller = function (h) {
        ...
        return h = a.extend({
            ...
            const k = a(this);
            let l = k.outerHeight(), m = a(window).width(), n = k.offset().top, o = 0, p = function (a, b) {// console.log(`offset ${scrollOffset} => ${transform - scrollOffset}`)
                return a || (o = b), b - o
            };
            const q = k.data('paroller-type'), r = k.data('paroller-direction'), s = k.data('paroller-transition'),
                t = k.css('transform'), u = s ? s : h.transition, v = q ? q : h.type, w = r ? r : h.direction;
            let x = 0, y = f.bgOffset(n, x), z = f.transform(n, x, i, l);
            'background' === v ? 'vertical' === w ? e.bgVertical(k, y) : 'horizontal' === w && e.bgHorizontal(k, y) : 'foreground' === v && ('vertical' === w ? e.vertical(k, z, u, t) : 'horizontal' === w && e.horizontal(k, z, u, t)), a(window).on('resize', function () {
                ...
                let g = a(this).scrollTop(), o = a(document).scrollTop();
                x = f.factor(k, m, h);
...
jQuery(document).ready((function (s) {
    ...
    function d(s) {
        ...
        } else s.parents(".cd-headline").hasClass("clip") ? s.parents(".cd-words-wrapper").animate({width: "2px"}, 600, (function () {
            h(s, i), l(i)
    ...
    function l(s, i) {
        s.parents(".cd-headline").hasClass("type") ? (o(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".cd-headline").hasClass("clip") && s.parents(".cd-words-wrapper").animate({width: s.width() + 10}, 600, (function () {
            setTimeout((function () {
                d(s)
            }), 1500)
        }))
