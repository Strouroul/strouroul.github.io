...
let my_services={
    ...
    "front_end_long_2": "As a front-end developer, I specialize in translating design concepts into interactive and visually stunning websites. Leveraging my skills in HTML, CSS, and JavaScript, I am dedicated to crafting responsive and user-centric interfaces. Collaborating closely with design teams, I ensure the fusion of aesthetics and functionality, delivering a seamless and engaging online experience for users.",
    ...
    "web_design_long_2": "Within the domain of web design, my commitment lies in harmonizing creativity with functionality. Armed with expertise in diverse design tools and principles, I excel in constructing visually captivating layouts and graphics. My objective is to elevate the aesthetic and user engagement of web projects, guaranteeing a delightful and memorable online experience."
}